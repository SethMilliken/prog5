...
int checkPath(Coordinates path[], int pathCount, int pathNum, short **map2, int width)
{
  int total = 0;
  ...
  int pathCounts[50], int width)
{
  ...
  {
    total += checkPath(paths[i], pathCounts[i], i, map2, width);
...
int main(int argc, char* argv[])
{
  ...
  int trainTime = checkRoutes(map2, cityPos, cityCount, paths, pathCounts, width);
